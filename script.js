...
{q:"اگر ▲ + ▲ = 18 و ▲ + ● = 13 باشد، مقدار ● چند است؟",o:["۴","۵","۶","۷"],a:1,e:"از 2▲=18 داریم ▲=9. سپس 9+●=13، پس ●=4. پاسخ صحیح گزینه اول است."},
...
{q:"علی از رضا بلندتر است. رضا از مهدی بلندتر است. سارا از علی کوتاه‌تر ولی از مهدی بلندتر است. ترتیب افراد از بلندترین به کوتاه‌ترین کدام است؟",o:["علی، سارا، رضا، مهدی","علی، رضا، سارا، مهدی","سارا، علی، رضا، مهدی","علی، سارا، مهدی، رضا"],a:0,e:"از روابط داریم علی > رضا > مهدی و همچنین علی > سارا > مهدی. درباره رابطه سارا و رضا داده مستقیم نداریم؛ بنابراین این سؤال در نسخه اولیه ابهام دارد و گزینه الف صرفاً یکی از حالت‌های ممکن است. این سؤال را در نسخه بعدی با رابطه کافی اصلاح می‌کنیم."}
];
